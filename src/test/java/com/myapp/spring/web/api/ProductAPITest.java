...
public class ProductAPITest {
	...
	public void testFindPriceGreaterThan() throws Exception{
		...
		.andExpect(jsonPath("$[2].productName", is("Sasmung")))
		.andExpect(jsonPath("$[2].description", is("GalaxyNote12")))
		.andExpect(jsonPath("$[2].price", is(50000.00)))
		.andExpect(jsonPath("$[2].starRating", is(4.1)))
		
		.andExpect(jsonPath("$[3].productId", is(4)))
		.andExpect(jsonPath("$[3].productName", is("Oneplus")))
		.andExpect(jsonPath("$[3].description", is("Oneplus9Pro")))
		.andExpect(jsonPath("$[3].price", is(60000.00)))
		.andExpect(jsonPath("$[3].starRating", is(4.5)))
